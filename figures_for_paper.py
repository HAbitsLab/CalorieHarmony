...
#     ax.axhline(0, color='gray', linestyle=':', zorder=20) # 0 line
    ...
    if title=='Compendium METs vs Google Fit METs':
        ax.set_ylim([-13, 13])
...
def blandAltman_lab(df, filename, color_dic, color_by):
    ...
    ax1 = plot_subplot(ax1, 'MET (Ainsworth)', 'Ainsworth-Est', df,
                       'Compendium METs \n\n(a)', 'Compendium METs - WRIST METs',
                       'Compendium METs vs WRIST METs',
                       color_dic, color_by)
    ...
    ax3 = plot_subplot(ax3, 'MET (Ainsworth)', 'VM3-Est', df, 
                       'Compendium METs \n\n(d)', 'ActiGraph VM3 METs - WRIST METs', 
                       'ActiGraph VM3 METs vs WRIST METs',
                       color_dic, color_by)
...
def blandAltman_wild(df, filename, color_dic, color_by):
	...
	plot_subplot(ax1, 'MET (VM3)', 'VM3-Est', inwild, 
	                       'ActiGraph VM3 METs', 'ActiGraph VM3 METs - WRIST METs',
